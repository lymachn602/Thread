package com.example.linyuming.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void threadclass(View v){
        ...
        ThreadSample thread1 = new ThreadSample("线程二");
        thread1.start();
        ThreadSample thread2 = new ThreadSample("线程一");
                thread2.start();
    }
    public void runableinterface(View v){
        ...
        Thread thread1 = new Thread(new RunnableExample("线程二"));
        thread1.start();
